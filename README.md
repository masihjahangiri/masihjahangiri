...
Full-stack engineer with 10 years of experience building production systems end-to-end — with a particular depth on the frontend. My work spans polished, accessible UIs to backend APIs and cloud infrastructure, but Svelte and React are where I go deepest.
...
Built and operated a globally distributed subscription platform as sole developer — frontend architecture, UI, backend services, infrastructure, and operations.
...
- Built the full frontend with Next.js, React, and Svelte — component architecture, performance optimization, and WCAG-accessible UI
- Built production observability with Prometheus, Grafana, and Alertmanager — near-zero downtime maintained throughout
- Full application stack: NestJS + GraphQL + PostgreSQL backend; Next.js + React + Svelte frontend with TailwindCSS
- Multi-currency payment processing across 20 countries, handling subscriptions, renewals, and refunds

### What I Work On

- **Frontend development** — Svelte, React, Next.js, TypeScript, TailwindCSS, component architecture, design systems, performance, accessibility
...
- Led 15-person engineering team as CTO; contributed as senior frontend engineer across multiple product companies

### Links

- [masihj.com](https://masihj.com)
- [StackOverflow](https://stackoverflow.com/users/5062890/masih-jahangiri)
- [LinkedIn](https://linkedin.com/in/masihjahangiri)
